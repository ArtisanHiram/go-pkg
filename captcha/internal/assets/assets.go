package __obf_8f5275f3a8003202
...
func __obf_1025a93b0590acc7(__obf_140070dd96de37f2 string) ([]byte, error) {
	__obf_3d9adc33fda8258e, __obf_5d39baccf081788f := fs.ReadDir(Assets, __obf_140070dd96de37f2)
	if __obf_5d39baccf081788f != nil {
		return nil, __obf_5d39baccf081788f
	}

	if len(__obf_3d9adc33fda8258e) == 0 {
		return nil, fs.ErrNotExist
	}
	__obf_9b30afce4f65bdc4 := __obf_3d9adc33fda8258e[rand.IntN(len(__obf_3d9adc33fda8258e))]
	__obf_63bfc052d9a5cb4c := filepath.Join(__obf_140070dd96de37f2, __obf_9b30afce4f65bdc4.Name())
	__obf_df6463bce84bb25b, __obf_5d39baccf081788f := Assets.ReadFile(__obf_63bfc052d9a5cb4c)
	if __obf_5d39baccf081788f != nil {
		return nil, __obf_5d39baccf081788f
	}

	return __obf_df6463bce84bb25b, nil
}

func GetChineseChars() []string {
	return __obf_772ba1c8d0b3cba5
}

func GetAlphaChars() []string {
	return strings.Split(__obf_19e58944a3a95a3a, "")
}

func PickFont() (__obf_58c9d6723d6b8538 *opentype.Font, __obf_5d39baccf081788f error) {
	var __obf_3844b5f51c37842e []byte
	__obf_3844b5f51c37842e, __obf_5d39baccf081788f = __obf_1025a93b0590acc7("assets/fonts")
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_58c9d6723d6b8538, __obf_5d39baccf081788f = opentype.Parse(__obf_3844b5f51c37842e)
	if __obf_5d39baccf081788f != nil {
		return
	}

	return __obf_58c9d6723d6b8538, nil
}

func PickBgImage() (__obf_c504b0d35848bb2b image.Image, __obf_5d39baccf081788f error) {
	var __obf_3844b5f51c37842e []byte
	__obf_3844b5f51c37842e, __obf_5d39baccf081788f = __obf_1025a93b0590acc7("assets/images")
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_c504b0d35848bb2b, __obf_5d39baccf081788f = util.DecodeByteToJpeg(__obf_3844b5f51c37842e)
	return
}

func PickThumbImage() (__obf_c504b0d35848bb2b image.Image, __obf_5d39baccf081788f error) {
	var __obf_3844b5f51c37842e []byte
	__obf_3844b5f51c37842e, __obf_5d39baccf081788f = __obf_1025a93b0590acc7("assets/thumbs")
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_c504b0d35848bb2b, __obf_5d39baccf081788f = util.DecodeByteToJpeg(__obf_3844b5f51c37842e)
...
func GetShapes() (__obf_85c8eba2ef537ec7 []image.Image, __obf_5d39baccf081788f error) {
	var __obf_3d9adc33fda8258e []fs.DirEntry
	__obf_3d9adc33fda8258e, __obf_5d39baccf081788f = fs.ReadDir(Assets, __obf_ac42094f9370a557)
	if __obf_5d39baccf081788f != nil {
		return
	}

	if len(__obf_3d9adc33fda8258e) == 0 {
		__obf_5d39baccf081788f = fs.ErrNotExist
		return
	}
	var __obf_3844b5f51c37842e []byte
	var __obf_c504b0d35848bb2b image.Image
	__obf_85c8eba2ef537ec7 = make([]image.Image, 0, len(__obf_3d9adc33fda8258e))
	for _, __obf_9b30afce4f65bdc4 := range __obf_3d9adc33fda8258e {
		__obf_63bfc052d9a5cb4c := filepath.Join(__obf_ac42094f9370a557, __obf_9b30afce4f65bdc4.Name())
		__obf_3844b5f51c37842e, _ = Assets.ReadFile(__obf_63bfc052d9a5cb4c)
		if __obf_3844b5f51c37842e != nil {
			__obf_c504b0d35848bb2b, _ = util.DecodeByteToPng(__obf_3844b5f51c37842e)
			if __obf_c504b0d35848bb2b != nil {
				__obf_85c8eba2ef537ec7 = append(__obf_85c8eba2ef537ec7, __obf_c504b0d35848bb2b)
			}
		}
	}
	return
...
func PickShapeImage() (__obf_c504b0d35848bb2b image.Image, __obf_5d39baccf081788f error) {
	var __obf_3844b5f51c37842e []byte
	__obf_3844b5f51c37842e, __obf_5d39baccf081788f = __obf_1025a93b0590acc7("assets/shapes")
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_c504b0d35848bb2b, __obf_5d39baccf081788f = util.DecodeByteToPng(__obf_3844b5f51c37842e)
	return
}

func PickTile() (__obf_c504b0d35848bb2b GraphImage, __obf_5d39baccf081788f error) {
	var __obf_3d9adc33fda8258e []fs.DirEntry
	__obf_3d9adc33fda8258e, __obf_5d39baccf081788f = fs.ReadDir(Assets, __obf_a78950aa03b2ece9)
	if __obf_5d39baccf081788f != nil {
		return
	}
	...
	__obf_9b30afce4f65bdc4 := util.PickN(__obf_3d9adc33fda8258e, 1)[0]
	__obf_fd3da0988733581c := filepath.Join(__obf_a78950aa03b2ece9, __obf_9b30afce4f65bdc4.Name(), "mask.png")
	__obf_9749d3d3685a5616 := filepath.Join(__obf_a78950aa03b2ece9, __obf_9b30afce4f65bdc4.Name(), "shadow.png")
	__obf_a914f37eef410153 := filepath.Join(__obf_a78950aa03b2ece9, __obf_9b30afce4f65bdc4.Name(), "overlay.png")
	var __obf_3844b5f51c37842e []byte
	__obf_3844b5f51c37842e, __obf_5d39baccf081788f = Assets.ReadFile(__obf_fd3da0988733581c)
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_c504b0d35848bb2b.
		Mask, __obf_5d39baccf081788f = util.DecodeByteToPng(__obf_3844b5f51c37842e)
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_3844b5f51c37842e, __obf_5d39baccf081788f = Assets.ReadFile(__obf_9749d3d3685a5616)
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_c504b0d35848bb2b.
		Shadow, __obf_5d39baccf081788f = util.DecodeByteToPng(__obf_3844b5f51c37842e)
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_3844b5f51c37842e, __obf_5d39baccf081788f = Assets.ReadFile(__obf_a914f37eef410153)
	if __obf_5d39baccf081788f != nil {
		return
	}
	__obf_c504b0d35848bb2b.
		Overlay, __obf_5d39baccf081788f = util.DecodeByteToPng(__obf_3844b5f51c37842e)
	return
