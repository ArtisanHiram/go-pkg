package __obf_db6380fb9efa14fa
...
func __obf_2da43f7b9725b7cf(__obf_31eeac65d0c51167 string) ([]byte, error) {
	__obf_588d2da7174b2414, __obf_020cabc33946b3bf := fs.ReadDir(Assets, __obf_31eeac65d0c51167)
	if __obf_020cabc33946b3bf != nil {
		return nil, __obf_020cabc33946b3bf
	}

	if len(__obf_588d2da7174b2414) == 0 {
		return nil, fs.ErrNotExist
	}
	__obf_764ec2e288c4d77b := __obf_588d2da7174b2414[rand.IntN(len(__obf_588d2da7174b2414))]
	__obf_b35e685cd1190677 := filepath.Join(__obf_31eeac65d0c51167, __obf_764ec2e288c4d77b.Name())
	__obf_c8be72d59db7464d, __obf_020cabc33946b3bf := Assets.ReadFile(__obf_b35e685cd1190677)
	if __obf_020cabc33946b3bf != nil {
		return nil, __obf_020cabc33946b3bf
	}

	return __obf_c8be72d59db7464d, nil
}

func GetChineseChars() []string {
	return __obf_e94e94a7c8d6f8ae
}

func GetAlphaChars() []string {
	return strings.Split(__obf_bada99fdeb9fbb27, "")
}

func PickFont() (__obf_0997afdbf7915214 *opentype.Font, __obf_020cabc33946b3bf error) {
	var __obf_6b70b1ba1851b237 []byte
	__obf_6b70b1ba1851b237, __obf_020cabc33946b3bf = __obf_2da43f7b9725b7cf("assets/fonts")
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_0997afdbf7915214, __obf_020cabc33946b3bf = opentype.Parse(__obf_6b70b1ba1851b237)
	if __obf_020cabc33946b3bf != nil {
		return
	}

	return __obf_0997afdbf7915214, nil
}

func PickBgImage() (__obf_abc4cd1d1b0403db image.Image, __obf_020cabc33946b3bf error) {
	var __obf_6b70b1ba1851b237 []byte
	__obf_6b70b1ba1851b237, __obf_020cabc33946b3bf = __obf_2da43f7b9725b7cf("assets/images")
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_abc4cd1d1b0403db, __obf_020cabc33946b3bf = util.DecodeByteToJpeg(__obf_6b70b1ba1851b237)
	return
}

func PickThumbImage() (__obf_abc4cd1d1b0403db image.Image, __obf_020cabc33946b3bf error) {
	var __obf_6b70b1ba1851b237 []byte
	__obf_6b70b1ba1851b237, __obf_020cabc33946b3bf = __obf_2da43f7b9725b7cf("assets/thumbs")
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_abc4cd1d1b0403db, __obf_020cabc33946b3bf = util.DecodeByteToJpeg(__obf_6b70b1ba1851b237)
...
func GetShapes() (__obf_69dfaf5cd49ef617 []image.Image, __obf_020cabc33946b3bf error) {
	var __obf_588d2da7174b2414 []fs.DirEntry
	__obf_588d2da7174b2414, __obf_020cabc33946b3bf = fs.ReadDir(Assets, __obf_d90a2879f17f8633)
	if __obf_020cabc33946b3bf != nil {
		return
	}

	if len(__obf_588d2da7174b2414) == 0 {
		__obf_020cabc33946b3bf = fs.ErrNotExist
		return
	}
	var __obf_6b70b1ba1851b237 []byte
	var __obf_abc4cd1d1b0403db image.Image
	__obf_69dfaf5cd49ef617 = make([]image.Image, 0, len(__obf_588d2da7174b2414))
	for _, __obf_764ec2e288c4d77b := range __obf_588d2da7174b2414 {
		__obf_b35e685cd1190677 := filepath.Join(__obf_d90a2879f17f8633, __obf_764ec2e288c4d77b.Name())
		__obf_6b70b1ba1851b237, _ = Assets.ReadFile(__obf_b35e685cd1190677)
		if __obf_6b70b1ba1851b237 != nil {
			__obf_abc4cd1d1b0403db, _ = util.DecodeByteToPng(__obf_6b70b1ba1851b237)
			if __obf_abc4cd1d1b0403db != nil {
				__obf_69dfaf5cd49ef617 = append(__obf_69dfaf5cd49ef617, __obf_abc4cd1d1b0403db)
			}
		}
	}
	return
...
func PickShapeImage() (__obf_abc4cd1d1b0403db image.Image, __obf_020cabc33946b3bf error) {
	var __obf_6b70b1ba1851b237 []byte
	__obf_6b70b1ba1851b237, __obf_020cabc33946b3bf = __obf_2da43f7b9725b7cf("assets/shapes")
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_abc4cd1d1b0403db, __obf_020cabc33946b3bf = util.DecodeByteToPng(__obf_6b70b1ba1851b237)
	return
}

func PickTile() (__obf_abc4cd1d1b0403db GraphImage, __obf_020cabc33946b3bf error) {
	var __obf_588d2da7174b2414 []fs.DirEntry
	__obf_588d2da7174b2414, __obf_020cabc33946b3bf = fs.ReadDir(Assets, __obf_cd625611bac1c528)
	if __obf_020cabc33946b3bf != nil {
		return
	}
	...
	__obf_764ec2e288c4d77b := util.PickN(__obf_588d2da7174b2414, 1)[0]
	__obf_fafc84ff9af8e909 := filepath.Join(__obf_cd625611bac1c528, __obf_764ec2e288c4d77b.Name(), "mask.png")
	__obf_fb0f1c3978bfe227 := filepath.Join(__obf_cd625611bac1c528, __obf_764ec2e288c4d77b.Name(), "shadow.png")
	__obf_220f37291432b4ca := filepath.Join(__obf_cd625611bac1c528, __obf_764ec2e288c4d77b.Name(), "overlay.png")
	var __obf_6b70b1ba1851b237 []byte
	__obf_6b70b1ba1851b237, __obf_020cabc33946b3bf = Assets.ReadFile(__obf_fafc84ff9af8e909)
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_abc4cd1d1b0403db.
		Mask, __obf_020cabc33946b3bf = util.DecodeByteToPng(__obf_6b70b1ba1851b237)
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_6b70b1ba1851b237, __obf_020cabc33946b3bf = Assets.ReadFile(__obf_fb0f1c3978bfe227)
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_abc4cd1d1b0403db.
		Shadow, __obf_020cabc33946b3bf = util.DecodeByteToPng(__obf_6b70b1ba1851b237)
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_6b70b1ba1851b237, __obf_020cabc33946b3bf = Assets.ReadFile(__obf_220f37291432b4ca)
	if __obf_020cabc33946b3bf != nil {
		return
	}
	__obf_abc4cd1d1b0403db.
		Overlay, __obf_020cabc33946b3bf = util.DecodeByteToPng(__obf_6b70b1ba1851b237)
	return
