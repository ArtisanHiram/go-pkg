package __obf_13471d76be2e4763
...
func __obf_1e6bdd8d386b6272(__obf_5c95515d26f21446 string) ([]byte, error) {
	__obf_2ec3f5f18edf69fc, __obf_717efe1f918dfb40 := fs.ReadDir(Assets, __obf_5c95515d26f21446)
	if __obf_717efe1f918dfb40 != nil {
		return nil, __obf_717efe1f918dfb40
	}

	if len(__obf_2ec3f5f18edf69fc) == 0 {
		return nil, fs.ErrNotExist
	}
	__obf_81b9bde4468ef81a := __obf_2ec3f5f18edf69fc[rand.IntN(len(__obf_2ec3f5f18edf69fc))]
	__obf_c788151fe5749161 := filepath.Join(__obf_5c95515d26f21446, __obf_81b9bde4468ef81a.Name())
	__obf_a13fe606c785dab2, __obf_717efe1f918dfb40 := Assets.ReadFile(__obf_c788151fe5749161)
	if __obf_717efe1f918dfb40 != nil {
		return nil, __obf_717efe1f918dfb40
	}

	return __obf_a13fe606c785dab2, nil
}

func GetChineseChars() []string {
	return __obf_18a82938b90a0b4f
}

func GetAlphaChars() []string {
	return strings.Split(__obf_05018f9c864f81da, "")
}

func PickFont() (__obf_1fc9369eca50dadd *opentype.Font, __obf_717efe1f918dfb40 error) {
	var __obf_757584be588b35ed []byte
	__obf_757584be588b35ed, __obf_717efe1f918dfb40 = __obf_1e6bdd8d386b6272("assets/fonts")
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_1fc9369eca50dadd, __obf_717efe1f918dfb40 = opentype.Parse(__obf_757584be588b35ed)
	if __obf_717efe1f918dfb40 != nil {
		return
	}

	return __obf_1fc9369eca50dadd, nil
}

func PickBgImage() (__obf_251cc2b8f3efa6d5 image.Image, __obf_717efe1f918dfb40 error) {
	var __obf_757584be588b35ed []byte
	__obf_757584be588b35ed, __obf_717efe1f918dfb40 = __obf_1e6bdd8d386b6272("assets/images")
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_251cc2b8f3efa6d5, __obf_717efe1f918dfb40 = util.DecodeByteToJpeg(__obf_757584be588b35ed)
	return
}

func PickThumbImage() (__obf_251cc2b8f3efa6d5 image.Image, __obf_717efe1f918dfb40 error) {
	var __obf_757584be588b35ed []byte
	__obf_757584be588b35ed, __obf_717efe1f918dfb40 = __obf_1e6bdd8d386b6272("assets/thumbs")
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_251cc2b8f3efa6d5, __obf_717efe1f918dfb40 = util.DecodeByteToJpeg(__obf_757584be588b35ed)
...
func GetShapes() (__obf_ed06976ea06f8a8e []image.Image, __obf_717efe1f918dfb40 error) {
	var __obf_2ec3f5f18edf69fc []fs.DirEntry
	__obf_2ec3f5f18edf69fc, __obf_717efe1f918dfb40 = fs.ReadDir(Assets, __obf_b1827175f4d107c9)
	if __obf_717efe1f918dfb40 != nil {
		return
	}

	if len(__obf_2ec3f5f18edf69fc) == 0 {
		__obf_717efe1f918dfb40 = fs.ErrNotExist
		return
	}
	var __obf_757584be588b35ed []byte
	var __obf_251cc2b8f3efa6d5 image.Image
	__obf_ed06976ea06f8a8e = make([]image.Image, 0, len(__obf_2ec3f5f18edf69fc))
	for _, __obf_81b9bde4468ef81a := range __obf_2ec3f5f18edf69fc {
		__obf_c788151fe5749161 := filepath.Join(__obf_b1827175f4d107c9, __obf_81b9bde4468ef81a.Name())
		__obf_757584be588b35ed, _ = Assets.ReadFile(__obf_c788151fe5749161)
		if __obf_757584be588b35ed != nil {
			__obf_251cc2b8f3efa6d5, _ = util.DecodeByteToPng(__obf_757584be588b35ed)
			if __obf_251cc2b8f3efa6d5 != nil {
				__obf_ed06976ea06f8a8e = append(__obf_ed06976ea06f8a8e, __obf_251cc2b8f3efa6d5)
			}
		}
	}
	return
...
func PickShapeImage() (__obf_251cc2b8f3efa6d5 image.Image, __obf_717efe1f918dfb40 error) {
	var __obf_757584be588b35ed []byte
	__obf_757584be588b35ed, __obf_717efe1f918dfb40 = __obf_1e6bdd8d386b6272("assets/shapes")
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_251cc2b8f3efa6d5, __obf_717efe1f918dfb40 = util.DecodeByteToPng(__obf_757584be588b35ed)
	return
}

func PickTile() (__obf_251cc2b8f3efa6d5 GraphImage, __obf_717efe1f918dfb40 error) {
	var __obf_2ec3f5f18edf69fc []fs.DirEntry
	__obf_2ec3f5f18edf69fc, __obf_717efe1f918dfb40 = fs.ReadDir(Assets, __obf_86b50a15bf244962)
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	...
	__obf_81b9bde4468ef81a := util.PickN(__obf_2ec3f5f18edf69fc, 1)[0]
	__obf_6a9aea6c57e1725f := filepath.Join(__obf_86b50a15bf244962, __obf_81b9bde4468ef81a.Name(), "mask.png")
	__obf_c9533e39b6f55bd3 := filepath.Join(__obf_86b50a15bf244962, __obf_81b9bde4468ef81a.Name(), "shadow.png")
	__obf_f111d3a0febf9b54 := filepath.Join(__obf_86b50a15bf244962, __obf_81b9bde4468ef81a.Name(), "overlay.png")
	var __obf_757584be588b35ed []byte
	__obf_757584be588b35ed, __obf_717efe1f918dfb40 = Assets.ReadFile(__obf_6a9aea6c57e1725f)
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_251cc2b8f3efa6d5.
		Mask, __obf_717efe1f918dfb40 = util.DecodeByteToPng(__obf_757584be588b35ed)
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_757584be588b35ed, __obf_717efe1f918dfb40 = Assets.ReadFile(__obf_c9533e39b6f55bd3)
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_251cc2b8f3efa6d5.
		Shadow, __obf_717efe1f918dfb40 = util.DecodeByteToPng(__obf_757584be588b35ed)
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_757584be588b35ed, __obf_717efe1f918dfb40 = Assets.ReadFile(__obf_f111d3a0febf9b54)
	if __obf_717efe1f918dfb40 != nil {
		return
	}
	__obf_251cc2b8f3efa6d5.
		Overlay, __obf_717efe1f918dfb40 = util.DecodeByteToPng(__obf_757584be588b35ed)
	return
