...
func __obf_a44f23cf6dd3ca2c(__obf_e7d1f50fc57ec122 string) ([]byte, error) {
	__obf_fe39797f4a925551, __obf_335fb0d6019c95ed := fs.ReadDir(Assets, __obf_e7d1f50fc57ec122)
	if __obf_335fb0d6019c95ed != nil {
		return nil, __obf_335fb0d6019c95ed
	}

	if len(__obf_fe39797f4a925551) == 0 {
		return nil, fs.ErrNotExist
	}

	__obf_1ab3935315c51430 := __obf_fe39797f4a925551[rand.IntN(len(__obf_fe39797f4a925551))]
	__obf_4fe24998235d1d39 := filepath.Join(__obf_e7d1f50fc57ec122, __obf_1ab3935315c51430.Name())

	__obf_81400dcceb9ec3a0, __obf_335fb0d6019c95ed := Assets.ReadFile(__obf_4fe24998235d1d39)
	if __obf_335fb0d6019c95ed != nil {
		return nil, __obf_335fb0d6019c95ed
	}

	return __obf_81400dcceb9ec3a0, nil
}

func GetChineseChars() []string {
	return __obf_71ba2a342f5d29ee
}

func GetAlphaChars() []string {
	return strings.Split(__obf_c8191cc3f0a7c47e, "")
}

func PickFont() (__obf_8c5158e065f0827a *opentype.Font, __obf_335fb0d6019c95ed error) {
	var __obf_34e3aa93781f22e3 []byte
	__obf_34e3aa93781f22e3, __obf_335fb0d6019c95ed = __obf_a44f23cf6dd3ca2c("assets/fonts")
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_8c5158e065f0827a, __obf_335fb0d6019c95ed = opentype.Parse(__obf_34e3aa93781f22e3)
	if __obf_335fb0d6019c95ed != nil {
		return
	}

	return __obf_8c5158e065f0827a, nil
}

func PickBgImage() (__obf_d1b36837c286905e image.Image, __obf_335fb0d6019c95ed error) {
	var __obf_34e3aa93781f22e3 []byte
	__obf_34e3aa93781f22e3, __obf_335fb0d6019c95ed = __obf_a44f23cf6dd3ca2c("assets/images")
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_d1b36837c286905e, __obf_335fb0d6019c95ed = DecodeByteToJpeg(__obf_34e3aa93781f22e3)
	return
}

func PickThumbImage() (__obf_d1b36837c286905e image.Image, __obf_335fb0d6019c95ed error) {
	var __obf_34e3aa93781f22e3 []byte
	__obf_34e3aa93781f22e3, __obf_335fb0d6019c95ed = __obf_a44f23cf6dd3ca2c("assets/thumbs")
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_d1b36837c286905e, __obf_335fb0d6019c95ed = DecodeByteToJpeg(__obf_34e3aa93781f22e3)
...
func GetShapes() (__obf_2264219507fde4de []image.Image, __obf_335fb0d6019c95ed error) {
	var __obf_fe39797f4a925551 []fs.DirEntry
	__obf_fe39797f4a925551, __obf_335fb0d6019c95ed = fs.ReadDir(Assets, __obf_58fe9523f0123475)
	if __obf_335fb0d6019c95ed != nil {
		return
	}

	if len(__obf_fe39797f4a925551) == 0 {
		__obf_335fb0d6019c95ed = fs.ErrNotExist
		return
	}
	var __obf_34e3aa93781f22e3 []byte
	var __obf_d1b36837c286905e image.Image
	__obf_2264219507fde4de = make([]image.Image, 0, len(__obf_fe39797f4a925551))
	for _, __obf_1ab3935315c51430 := range __obf_fe39797f4a925551 {
		__obf_4fe24998235d1d39 := filepath.Join(__obf_58fe9523f0123475, __obf_1ab3935315c51430.Name())
		__obf_34e3aa93781f22e3, _ = Assets.ReadFile(__obf_4fe24998235d1d39)
		if __obf_34e3aa93781f22e3 != nil {
			__obf_d1b36837c286905e, _ = DecodeByteToPng(__obf_34e3aa93781f22e3)
			if __obf_d1b36837c286905e != nil {
				__obf_2264219507fde4de = append(__obf_2264219507fde4de, __obf_d1b36837c286905e)
			}
		}
	}
	return
...
func PickShapeImage() (__obf_d1b36837c286905e image.Image, __obf_335fb0d6019c95ed error) {
	var __obf_34e3aa93781f22e3 []byte
	__obf_34e3aa93781f22e3, __obf_335fb0d6019c95ed = __obf_a44f23cf6dd3ca2c("assets/shapes")
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_d1b36837c286905e, __obf_335fb0d6019c95ed = DecodeByteToPng(__obf_34e3aa93781f22e3)
	return
}

func PickTile() (__obf_d1b36837c286905e GraphImage, __obf_335fb0d6019c95ed error) {
	var __obf_fe39797f4a925551 []fs.DirEntry
	__obf_fe39797f4a925551, __obf_335fb0d6019c95ed = fs.ReadDir(Assets, __obf_c0bb08c8eb30117a)
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	...
	__obf_1ab3935315c51430 := PickN(__obf_fe39797f4a925551, 1)[0]
	__obf_71bb5cb69fd330b9 := filepath.Join(__obf_c0bb08c8eb30117a, __obf_1ab3935315c51430.Name(), "mask.png")
	__obf_fe069ed51099a5e6 := filepath.Join(__obf_c0bb08c8eb30117a, __obf_1ab3935315c51430.Name(), "shadow.png")
	__obf_55dc7455e61807fb := filepath.Join(__obf_c0bb08c8eb30117a, __obf_1ab3935315c51430.Name(), "overlay.png")
	var __obf_34e3aa93781f22e3 []byte
	__obf_34e3aa93781f22e3, __obf_335fb0d6019c95ed = Assets.ReadFile(__obf_71bb5cb69fd330b9)
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_d1b36837c286905e.Mask, __obf_335fb0d6019c95ed = DecodeByteToPng(__obf_34e3aa93781f22e3)
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_34e3aa93781f22e3, __obf_335fb0d6019c95ed = Assets.ReadFile(__obf_fe069ed51099a5e6)
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_d1b36837c286905e.Shadow, __obf_335fb0d6019c95ed = DecodeByteToPng(__obf_34e3aa93781f22e3)
	if __obf_335fb0d6019c95ed != nil {
		return
	}

	__obf_34e3aa93781f22e3, __obf_335fb0d6019c95ed = Assets.ReadFile(__obf_55dc7455e61807fb)
	if __obf_335fb0d6019c95ed != nil {
		return
	}
	__obf_d1b36837c286905e.Overlay, __obf_335fb0d6019c95ed = DecodeByteToPng(__obf_34e3aa93781f22e3)
	return
