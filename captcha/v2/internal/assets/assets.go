package __obf_9ffc3e79ed019008
...
func __obf_b925c1e30ca44b0c(__obf_70d6ddc36aebdfdf string) ([]byte, error) {
	__obf_422be867813fd288, __obf_92b39ff61e3e0cc1 := fs.ReadDir(Assets, __obf_70d6ddc36aebdfdf)
	if __obf_92b39ff61e3e0cc1 != nil {
		return nil, __obf_92b39ff61e3e0cc1
	}

	if len(__obf_422be867813fd288) == 0 {
		return nil, fs.ErrNotExist
	}

	__obf_33e1ad76113e388d := __obf_422be867813fd288[rand.IntN(len(__obf_422be867813fd288))]
	__obf_5dd365f90bdb4fe3 := filepath.Join(__obf_70d6ddc36aebdfdf, __obf_33e1ad76113e388d.Name())

	__obf_64406fc02c0f0d32, __obf_92b39ff61e3e0cc1 := Assets.ReadFile(__obf_5dd365f90bdb4fe3)
	if __obf_92b39ff61e3e0cc1 != nil {
		return nil, __obf_92b39ff61e3e0cc1
	}

	return __obf_64406fc02c0f0d32, nil
}

func GetChineseChars() []string {
	return __obf_233a92fa07deb4a9
}

func GetAlphaChars() []string {
	return strings.Split(__obf_76405bac964e2a7a, "")
}

func PickFont() (__obf_a06f09ce6353c839 *opentype.Font, __obf_92b39ff61e3e0cc1 error) {
	var __obf_eaee799bc793db99 []byte
	__obf_eaee799bc793db99, __obf_92b39ff61e3e0cc1 = __obf_b925c1e30ca44b0c("assets/fonts")
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_a06f09ce6353c839, __obf_92b39ff61e3e0cc1 = opentype.Parse(__obf_eaee799bc793db99)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}

	return __obf_a06f09ce6353c839, nil
}

func PickBgImage() (__obf_9851a6712135d384 image.Image, __obf_92b39ff61e3e0cc1 error) {
	var __obf_eaee799bc793db99 []byte
	__obf_eaee799bc793db99, __obf_92b39ff61e3e0cc1 = __obf_b925c1e30ca44b0c("assets/images")
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_9851a6712135d384, __obf_92b39ff61e3e0cc1 = util.DecodeByteToJpeg(__obf_eaee799bc793db99)
	return
}

func PickThumbImage() (__obf_9851a6712135d384 image.Image, __obf_92b39ff61e3e0cc1 error) {
	var __obf_eaee799bc793db99 []byte
	__obf_eaee799bc793db99, __obf_92b39ff61e3e0cc1 = __obf_b925c1e30ca44b0c("assets/thumbs")
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_9851a6712135d384, __obf_92b39ff61e3e0cc1 = util.DecodeByteToJpeg(__obf_eaee799bc793db99)
...
func GetShapes() (__obf_b15b53000378ebfd []image.Image, __obf_92b39ff61e3e0cc1 error) {
	var __obf_422be867813fd288 []fs.DirEntry
	__obf_422be867813fd288, __obf_92b39ff61e3e0cc1 = fs.ReadDir(Assets, __obf_ca57816782ba34b1)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}

	if len(__obf_422be867813fd288) == 0 {
		__obf_92b39ff61e3e0cc1 = fs.ErrNotExist
		return
	}
	var __obf_eaee799bc793db99 []byte
	var __obf_9851a6712135d384 image.Image
	__obf_b15b53000378ebfd = make([]image.Image, 0, len(__obf_422be867813fd288))
	for _, __obf_33e1ad76113e388d := range __obf_422be867813fd288 {
		__obf_5dd365f90bdb4fe3 := filepath.Join(__obf_ca57816782ba34b1, __obf_33e1ad76113e388d.Name())
		__obf_eaee799bc793db99, _ = Assets.ReadFile(__obf_5dd365f90bdb4fe3)
		if __obf_eaee799bc793db99 != nil {
			__obf_9851a6712135d384, _ = util.DecodeByteToPng(__obf_eaee799bc793db99)
			if __obf_9851a6712135d384 != nil {
				__obf_b15b53000378ebfd = append(__obf_b15b53000378ebfd, __obf_9851a6712135d384)
			}
		}
	}
	return
...
func PickShapeImage() (__obf_9851a6712135d384 image.Image, __obf_92b39ff61e3e0cc1 error) {
	var __obf_eaee799bc793db99 []byte
	__obf_eaee799bc793db99, __obf_92b39ff61e3e0cc1 = __obf_b925c1e30ca44b0c("assets/shapes")
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_9851a6712135d384, __obf_92b39ff61e3e0cc1 = util.DecodeByteToPng(__obf_eaee799bc793db99)
	return
}

func PickTile() (__obf_9851a6712135d384 GraphImage, __obf_92b39ff61e3e0cc1 error) {
	var __obf_422be867813fd288 []fs.DirEntry
	__obf_422be867813fd288, __obf_92b39ff61e3e0cc1 = fs.ReadDir(Assets, __obf_11e1568a967e3a75)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	...
	__obf_33e1ad76113e388d := util.PickN(__obf_422be867813fd288, 1)[0]
	__obf_f112d0d9b3e8ef3a := filepath.Join(__obf_11e1568a967e3a75, __obf_33e1ad76113e388d.Name(), "mask.png")
	__obf_e83ca8838c337c96 := filepath.Join(__obf_11e1568a967e3a75, __obf_33e1ad76113e388d.Name(), "shadow.png")
	__obf_90f84702c94f1e78 := filepath.Join(__obf_11e1568a967e3a75, __obf_33e1ad76113e388d.Name(), "overlay.png")
	var __obf_eaee799bc793db99 []byte
	__obf_eaee799bc793db99, __obf_92b39ff61e3e0cc1 = Assets.ReadFile(__obf_f112d0d9b3e8ef3a)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_9851a6712135d384.Mask, __obf_92b39ff61e3e0cc1 = util.DecodeByteToPng(__obf_eaee799bc793db99)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_eaee799bc793db99, __obf_92b39ff61e3e0cc1 = Assets.ReadFile(__obf_e83ca8838c337c96)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_9851a6712135d384.Shadow, __obf_92b39ff61e3e0cc1 = util.DecodeByteToPng(__obf_eaee799bc793db99)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}

	__obf_eaee799bc793db99, __obf_92b39ff61e3e0cc1 = Assets.ReadFile(__obf_90f84702c94f1e78)
	if __obf_92b39ff61e3e0cc1 != nil {
		return
	}
	__obf_9851a6712135d384.Overlay, __obf_92b39ff61e3e0cc1 = util.DecodeByteToPng(__obf_eaee799bc793db99)
	return
